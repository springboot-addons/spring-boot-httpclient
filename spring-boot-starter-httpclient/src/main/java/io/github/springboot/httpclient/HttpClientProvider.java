...
public class HttpClientProvider {
    ...
    public CloseableHttpClient httpClient() {
        ...
        String userAgent = config.getGlobalConfiguration(ConfigurationConstants.USER_AGENT);
        ...
        if (config.isCookieManagementDisabled() || cookieStoreProvider.getIfAvailable() == null) {
            clientBuilder.disableCookieManagement();
        } else {
            clientBuilder.setDefaultCookieStore(cookieStoreProvider.getIfAvailable());
        }
