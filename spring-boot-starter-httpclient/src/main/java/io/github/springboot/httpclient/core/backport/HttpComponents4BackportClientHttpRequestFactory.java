 ...
 * @since 3.1
 */
public class HttpComponents4BackportClientHttpRequestFactory implements ClientHttpRequestFactory, DisposableBean {
	 ...
	 */
	public HttpComponents4BackportClientHttpRequestFactory() {
	 ...
	 */
	public HttpComponents4BackportClientHttpRequestFactory(HttpClient httpClient) {
	...
	public ClientHttpRequest createRequest(URI uri, HttpMethod httpMethod) throws IOException {
		...
		if (this.bufferRequestBody) {
			return new HttpComponents4BackportClientHttpRequest(client, httpRequest, context);
		}
		else {
			return new HttpComponents4BackportStreamingClientHttpRequest(client, httpRequest, context);
		}
	}
	 ...
	 * returned as part of a {@link HttpComponents4BackportClientHttpRequest}.
