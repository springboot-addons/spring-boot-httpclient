 ...
 */
final class HttpComponents4BackportStreamingClientHttpRequest extends AbstractClientHttpRequest
	...
	HttpComponents4BackportStreamingClientHttpRequest(HttpClient client, HttpUriRequest request, HttpContext context) {
	...
	protected ClientHttpResponse executeInternal(HttpHeaders headers) throws IOException {
		HttpComponents4BackportClientHttpRequest.addHeaders(this.httpRequest, headers);
