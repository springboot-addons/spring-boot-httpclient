...
import io.micrometer.core.instrument.binder.httpcomponents.hc5.OpenTelemetryApacheHttpClientObservationConvention;
...
public class HttpClientActuatorAutoConfiguration {
	...
	public ObservationExecChainHandler observationExecChainHandler(ObservationRegistry observationRegistry) {
		return new ObservationExecChainHandler(observationRegistry, OpenTelemetryApacheHttpClientObservationConvention.INSTANCE);
	}
